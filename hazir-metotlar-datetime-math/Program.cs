...
namespace hazir_metotlar_datetime_math
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(Math.Abs(-21)); // Mutlak değer alma
            Console.WriteLine(Math.Sin(45));
            Console.WriteLine(Math.Cos(90));
            Console.WriteLine(Math.Tan(10));

            Console.WriteLine(Math.Ceiling(10.1)); // Kendisinden büyük tam sayıya yuvarlıyor
            Console.WriteLine(Math.Round(10.1));  // Kendisine en yakın tam sayıya yuvarlıyor
            Console.WriteLine(Math.Floor(10.6)); //Kendisinden küçük en büyük tam sayıya yuvarlar
